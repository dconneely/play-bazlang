...
3080 LET S$ = "?"
3090 IF SU = 0 THEN LET S$ = CHR$(9824)
3100 IF SU = 1 THEN LET S$ = CHR$(9829)
3110 IF SU = 2 THEN LET S$ = CHR$(9827)
3120 IF SU = 3 THEN LET S$ = CHR$(9830)
3130 IF C = 0 THEN LET V$ = "?"
3135 IF C = 0 THEN LET S$ = "?"
3140 PRINT AT DY, DX; CHR$(9484); CHR$(9472); CHR$(9472); CHR$(9472); CHR$(9488)
3150 IF LEN(V$) = 2 THEN PRINT AT DY+1, DX; CHR$(9474); V$; " "; CHR$(9474)
3160 IF LEN(V$) = 1 THEN PRINT AT DY+1, DX; CHR$(9474); V$; "  "; CHR$(9474)
3165 PRINT AT DY+2, DX; CHR$(9474); " "; S$; AT DY+2, DX+4; CHR$(9474)
3170 PRINT AT DY+3, DX; CHR$(9492); CHR$(9472); CHR$(9472); CHR$(9472); CHR$(9496)
3180 RETURN