1000 REM ### 3D rotating tetrahedron ###
1010 PLOTMODE 8
1020 LET w = PLOTW : LET h = PLOTH
1025 BRIGHT 1
1030 LET centre_x = w / 2 : LET centre_y = h / 2
1040 LET s = h * 0.7
1050 LET num_vertices = 4
1060 LET num_edges = 6
...
4060 NEXT i
4070 CLS : RETURN
5000 DATA 0, 1.414, 0,  -1, -0.707, -0.816,  1, -0.707, -0.816,  0, -0.707, 1.633
5010 DATA 1,2, 2,3, 3,1, 1,4, 2,4, 3,4
